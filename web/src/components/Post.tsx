...
import {Heading,Grid,Flex,Text,useColorMode,Box,Image} from "@chakra-ui/core";
...
export default function Post() {
	...
	return (
		<ListItem width={["93%","70%","68%","60%","50%"]} marginTop="10px" height="auto" marginBottom="5px">
			<Grid
				height="auto"
				borderRadius="20px"
				width="100%"
